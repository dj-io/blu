...
def mock_config_with_cached_directories():
    return {
        "cached_directories": ["/path/to/project1", "/path/to/project2"]
    }
...
def test_cached_directories_with_choices(mock_getcwd, mock_questionary_select, mock_detect_directory, mock_config_with_cached_directories):
    """
    ...
    # Assert
    mock_questionary_select.assert_called_once_with("Select a directory:", choices=choices)
